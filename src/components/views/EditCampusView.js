      ...
      <div className={classes.root}>
        <div className={classes.formContainer}>
          ...
          <form style={{textAlign: 'center'}} onSubmit={(e) => handleSubmit(e)}>
            ...
            <label style= {{color:'#11153e', fontWeight: 'bold'}}>School Name: </label>
            <input type="text" name="name" onChange ={(e) => handleChange(e)}  value = {campus.name} required />
            <br/>
            <br/>

            <label style={{color:'#11153e', fontWeight: 'bold'}}>School Address: </label>
            <input type="text" name="address" onChange={(e) => handleChange(e)} value = {campus.address} required/>
            <br/>
            <br/>

            <label style={{color:'#11153e', fontWeight: 'bold'}}>Description: </label>
            <input type="text" name="description" onChange={(e) => handleChange(e)} value = {campus.description} required />
            <br/>
            <br/>
